...
class MySQLReback {
    ...
    private function getFile($fileName) {
        $this->content = '';
        $fileName = $this->trimPath($this->config['path'] . self::DIR_SEP . $fileName).'.sql';
        if (is_file($fileName)) {
    ...
    private function setFile() {
        ...
        $fileName = $this->trimPath($this->config['path'] . self::DIR_SEP . $recognize . '_' . date('YmdHis') . '.sql');
